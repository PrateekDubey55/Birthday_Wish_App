...
public class EntryForm extends javax.swing.JFrame {
    ...
    public EntryForm() {
        ...
        try
        {
            ...
            query = "select Aadhar from hbd";
            ps=con.prepareStatement(query);
            rs=ps.executeQuery();
            if(!rs.next())
            {
                id=1;
                unique=Double.toString(id);
    ...
    private void initComponents() {
        ...
        jTextField1.setToolTipText("Enter Your First Name Here");

        jTextField2.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        jTextField2.setToolTipText("Enter Your Last Name Here");
        ...
        jButton3.setToolTipText("Click To Go One Step Back");
        ...
        jTextField3.setToolTipText("Enter Date in (yyyy-mm-dd)");
